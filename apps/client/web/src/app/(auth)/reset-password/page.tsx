...
function ResetPasswordForm() {
  ...
  const handleSubmit = useCallback(
    async (e: FormEvent) => {
      ...
      // Client-side UX check that the two password fields match. Not a secret
      // comparison (both values are the user's own input in their browser), so
      // the timing-attack rule is a false positive here.
