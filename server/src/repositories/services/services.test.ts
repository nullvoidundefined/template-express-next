...
describe("services repository", () => {
  ...
  describe("listServices", () => {
    it("returns all services", async () => {
      ...
      expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining("SELECT * FROM services"));
    });
  ...
  describe("getServiceById", () => {
    it("returns service when found", async () => {
      ...
      expect(result).toEqual(mockService);
      expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining("WHERE id = $1"), [id]);
    });
  ...
  describe("updateService", () => {
    it("updates and returns the service", async () => {
      ...
      expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining("UPDATE services"), [
        id,
        "Updated",
      ]);
    });
  ...
  describe("deleteService", () => {
    it("returns true when deleted", async () => {
      ...
      expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining("DELETE FROM services"), [id]);
    });
